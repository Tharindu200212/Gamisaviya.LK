      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div
            ...
            className="bg-gradient-to-br from-amber-500 to-orange-500 text-white rounded-xl p-6 cursor-pointer hover:shadow-lg transition"
          >
            <ShoppingBag className="w-10 h-10 mb-3 opacity-80" />
            <p className="text-3xl font-bold mb-1">{cartCount}</p>
            <p className="text-amber-50">Items in Cart</p>
            {cartTotal > 0 && (
          ...
          >
            <Package className="w-10 h-10 mb-3 text-blue-500" />
            ...
            <div className="space-y-4">
              {recentOrders.map((order) => (
                <div
                  ...
                  className="border border-gray-200 rounded-lg p-4 hover:border-amber-300 hover:shadow-md transition cursor-pointer"
                >
