      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl p-6">
            ...
            <p className="text-green-50">Total Sellers</p>
          </div>

          <div className="bg-gradient-to-br from-green-500 to-amber-500 text-white rounded-xl p-6">
            <Package className="w-10 h-10 mb-3 opacity-80" />
            <p className="text-3xl font-bold mb-1">{stats.products.total}</p>
            <p className="text-green-50">Total Products</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl p-6">
            ...
            <p className="text-green-50">Platform Revenue</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <button
            ...
            className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl p-6 hover:shadow-xl transition text-left border-2 border-transparent hover:border-green-300"
          >
            <Database className="w-8 h-8 mb-3 opacity-90" />
            <h3 className="font-bold text-lg mb-2">Database Viewer</h3>
            <p className="text-green-100 text-sm">View and manage all database records</p>
          </button>

          <button
            onClick={() => navigate('/admin/seller-approval')}
            className="bg-white rounded-xl p-6 border-2 border-amber-200 hover:border-amber-400 hover:shadow-lg transition text-left relative"
          >
            {pendingApprovals > 0 && (
              ...
              {recentOrders.length === 0 ? (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="font-bold text-green-600">LKR {order.totalAmount.toLocaleString()}</p>
                    <span
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                ...
                <span className="text-2xl font-bold text-green-600">{stats.orders.total - stats.orders.completed}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
