...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-green-900 to-amber-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/become-seller" className="text-green-100 hover:text-white transition-colors">
                  Become a Seller
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-green-100">123, Main Street, Colombo 07, Sri Lanka</span>
              </li>
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-green-100">info@gamisaviya.lk</span>
              </li>
            </ul>
          </div>
        </div>
